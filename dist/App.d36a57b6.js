  ...
  _createClass(Card, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement("div", {
        ...
        className: "card__id"
      }, address.id), _react.default.createElement("div", {
        className: "card__name"
      }, address.name), _react.default.createElement("div", {
        className: "card__address"
      }, address.address), _react.default.createElement("div", {
        className: "card__pincode"
      }, address.pincode));
    }
  }]);
...
function (_Component) {
  ...
  _createClass(Searchbox, [{
    ...
    value: function searchAddress() {
      ...
      var all_addresses = this.getJson();
      var filtered = all_addresses.filter(function (el) {
        return el.id.containsString(query) || el.name.containsString(query) || el.address.containsString(query) || el.pincode.containsString(query);
      });
      this.setState({
    ...
    value: function handleKeyDown(event) {
      ...
      if (event.keyCode == 40) {
        var selected = (this.state.selectedSuggestionIndex + 1) % length;
        this.setState({
          selectedSuggestionIndex: selected
        });
      } else {
        var _selected = (this.state.selectedSuggestionIndex - 1) % length;

        this.setState({
          selectedSuggestionIndex: _selected
        });
      }
    }
  }, {
    ...
    value: function render() {
      ...
      var suggestionsList = suggestions.map(function (item, index) {
...
exports.default = _default;
},{"react":"../node_modules/react/index.js","./Card":"Card.js"}],"App.js":[function(require,module,exports) {
"use strict";
...
var App = function App() {
  return _react.default.createElement("div", null, _react.default.createElement(_Searchbox.default, null));
};
...
},{"react":"../node_modules/react/index.js","react-dom":"../node_modules/react-dom/index.js","./Searchbox":"Searchbox.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
